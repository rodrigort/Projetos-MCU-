...
void IpcNotifyInt_ISR(void)
{
	...
	if (interruptMasked == (1uL << USED_IPC_CHANNEL))
	{
		...
		if(CY_IPC_DRV_SUCCESS == Cy_IPC_Drv_ReadMsgWord(Cy_IPC_Drv_GetIpcBaseAddress(USED_IPC_CHANNEL), &u32Led_M7))
		{
			if((u32Led_M7 >= 0)&&(u32Led_M7 <= 99))
			{
				Cy_GPIO_Write(LED_1_PORT, LED_1_PIN, 1);    /* Led 1 Off */
				Cy_GPIO_Write(LED_2_PORT, LED_2_PIN, 1);    /* Led 2 Off */
				Cy_GPIO_Write(LED_3_PORT, LED_3_PIN, 1);    /* Led 3 Off */
			}
			if((u32Led_M7 >= 100)&&(u32Led_M7 <= 1363))
			{

				Cy_GPIO_Write(LED_1_PORT, LED_1_PIN, 0);    /* Led 1 On  */
				Cy_GPIO_Write(LED_2_PORT, LED_2_PIN, 1);    /* Led 2 Off */
				Cy_GPIO_Write(LED_3_PORT, LED_3_PIN, 1);    /* Led 3 Off */
			}
			if((u32Led_M7 >= 1364)&&(u32Led_M7 <= 2726))
			{
				Cy_GPIO_Write(LED_1_PORT, LED_1_PIN, 1);    /* Led 1 Off */
				Cy_GPIO_Write(LED_2_PORT, LED_2_PIN, 0);    /* Led 2 On */
				Cy_GPIO_Write(LED_3_PORT, LED_3_PIN, 1);    /* Led 3 Off */
			}
			if((u32Led_M7 >= 2727)&&(u32Led_M7 <= 3899))
			{
				Cy_GPIO_Write(LED_1_PORT, LED_1_PIN, 1);    /* Led 1 Off */
				Cy_GPIO_Write(LED_2_PORT, LED_2_PIN, 1);    /* Led 2 Off */
				Cy_GPIO_Write(LED_3_PORT, LED_3_PIN, 0);    /* Led 3 On */

			}
			if((u32Led_M7 >= 3900)&&(u32Led_M7 <= 4095))
			{
				Cy_GPIO_Write(LED_1_PORT, LED_1_PIN, 1);    /* Led 1 Off */
				Cy_GPIO_Write(LED_2_PORT, LED_2_PIN, 1);    /* Led 2 Off */
				Cy_GPIO_Write(LED_3_PORT, LED_3_PIN, 1);    /* Led 3 Off */
